                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <a href="#" class="btn btn-sm btn-primary like" data-pid={{$post->id}} data-uid={{Auth::user()->id}} title="Like">{{Auth::user()->likes()->where('post_id',$post->id)->first() ? Auth::user()->likes()->where('post_id',$post->id)->first()->like == 1 ? 'You liked this Post':'Like': 'Like'}}</a>
                                        <a href="#" class="btn btn-secondary btn-sm like" title="Dislike">{{Auth::user()->likes()->where('post_id',$post->id)->first() ? Auth::user()->likes()->where('post_id',$post->id)->first()->like == 0 ? 'You disliked this Post':'Dislike': 'Dislike'}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
